...
img1_path = original_folder_list[species_index] + "/images/" + "/" + sd_labels[0] + "/" + name[4:] + "-" + sd_labels[0] + "-" + "00" + ".png"
img2_path = original_folder_list[species_index] + "/images/" + "/" + sd_labels[0] + "/" + name[4:] + "-" + sd_labels[0] + "-" + "20" + ".png"


img1 = cv.imread(img1_path, cv.IMREAD_GRAYSCALE)  #queryimage # left image
img2 = cv.imread(img2_path, cv.IMREAD_GRAYSCALE) #trainimage # right image
sift = cv.SIFT_create()
